        ...
        <div className="max-w-md mx-auto px-4 py-16 min-h-[80vh]">
            <div className="bg-white p-8 sm:p-10 rounded-3xl shadow-2xl border border-indigo-100 animate-fadeInUp">
                ...
                <p className="text-gray-600 mb-8 text-center">
                    Join Pragya Print and unlock quick checkout features.
                </p>
                ...
                {/* Google Sign-up Placeholder with Inline SVG */}
                <Button 
                    variant="secondary" 
                    className="w-full py-3 flex items-center justify-center"
                    onClick={() => setError('Google Sign-Up integration coming in Phase 2!')}
                >
                ...
                <p className="text-center text-sm text-gray-600 mt-6">
                    ...
                    <NavLink to="/login" className="text-indigo-600 font-semibold hover:text-indigo-700 ml-1">
                        Sign In
                    </NavLink>
                </p>
            </div>
