 ...
 * @param {function} props.dispatchCart - The reducer function to modify the cart state.
 * @returns {JSX.Element}
 */
const Cart = ({ cart, dispatchCart }) => {
  ...
  const SHIPPING_FEE = 100; // Fixed shipping for orders below a threshold
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 min-h-[80vh]">
      <h1 className="text-4xl font-extrabold text-gray-900 mb-8 border-b pb-2 flex items-center">
        <ShoppingCart className="w-8 h-8 mr-3 text-indigo-600" /> Your Shopping
        Cart
      </h1>

      {/* Global Notification/Toast (Placeholder for modal/toast component) */}
      {notification && (
        <div
      ...
      {cart.length === 0 ? (
        <div className="text-center py-20 bg-gray-50 rounded-2xl shadow-lg border-4 border-dashed border-gray-300">
          ...
          <p className="text-gray-500 mt-2">
            Time to fill it with awesome prints.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {cart.map((item) => (
              <div
                key={item.itemId}
                className="flex flex-col sm:flex-row items-center bg-white p-4 rounded-2xl shadow-xl border border-gray-100 transition duration-300 transform hover:shadow-2xl"
              >
                {/* Item Image */}
                <div className="w-24 h-24 flex-shrink-0 overflow-hidden rounded-xl mr-4 mb-4 sm:mb-0 border border-gray-200">
                  <img
                    src={
                      ...
                      "https://placehold.co/100x100/e0e7ff/1e40af?text=PR"
                    }
            ...
            <div className="p-4 bg-gray-100 rounded-xl text-gray-600 flex items-center shadow-inner">
              ...
              Shipping is calculated based on the weight and dimensions of your
              selected products.
            </div>
          </div>
          ...
          <div className="lg:col-span-1 sticky top-24 h-fit bg-indigo-50 p-6 rounded-3xl shadow-2xl border border-indigo-100 animate-fadeInRight">
            ...
            <div className="space-y-3 text-gray-700 text-md mb-6">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold">
                  {actualShipping > 0 ? formatCurrency(actualShipping) : "FREE"}
                </span>
              </div>
              <div className="flex justify-between">
            ...
            <div className="mt-6 text-xs text-gray-500 flex items-center">
              ...
              Prices are approximate. Final cost will be confirmed at checkout.
            </div>
          </div>
        </div>
      )}
